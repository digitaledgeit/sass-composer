 ...
 * @param {string}                    [context.parent]     The path of the currently executing file
 ...
 */
AssetUrl.prototype.importer = function resolver(context, callback) {
...
AssetUrl.prototype.function = function(entry, dirname, asset) {
  ...
  //console.log(dirname, src, rel, dest);
  debug('Copying asset '+rel+' to '+dest);
  debug('');
