...
module.exports = function(context, callback) {
  ...
  var options = extend({
    ...
    basedir: path.resolve(path.dirname(context.entry), path.dirname(context.current)), //FIXME: not sure if resolving the directory of the current executing file, relative to the entry directory will always work
